...
\label{Capitulo2}
\lhead{Capítulo 2. \emph{Introducción}}
...
```{r, message=FALSE, fig.cap="Resultados de pobreza e indigencia de los aglomerados urbanos del Nordeste Argentino, período 2017-I Trim a 2023-II Trim."}
#grafico2 + grafico3 + plot_layout(guides = "collect") & theme(legend.position = "bottom")
```
